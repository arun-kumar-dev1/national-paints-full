...
const AttendanceTable = () => {
  ...
  const getDailyHours = (attendanceRecord, day) => {
    ...
    // Don't add extra 8 hours if employee actually worked - they get paid for actual hours
  ...
  const calculateTotalLeaves = (attendanceRecords) => {
    ...
    daysInMonth.forEach((day) => {
      ...
      // Count as leave if no attendance AND it's a regular working day that has passed
